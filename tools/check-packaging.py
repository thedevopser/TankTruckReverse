...
TankTruckReverse.toc figure bien dans la liste ADDON_FILES (passée en arguments
par le Makefile). Empêche le bug « fichier présent dans le .toc mais absent du
zip ».
...
(Textures/icon.tga via ## IconTexture, Media/backup_beep.ogg joué à l'exécution).
"""
import sys

TOC = "TankTruckReverse.toc"
